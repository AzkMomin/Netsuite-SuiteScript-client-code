                    ...
                    if (CommissionType != "") {
                        ...
                        if (processLine) {
                            ...
                            for (var i = 0; i < invLineItemCount; i++) {
                                ...
                                // account that contains 10 percent
                                var accountsWithPercent = ["590","592","594","596"]
                                log.debug('Income account found : ' ,accountsWithPercent.includes(account))
                                if (accountsWithPercent.includes(account)) {
                                    ...
                                    var comm_amt = parseFloat(Est_GrossProfit * (0 / 100));
                                    // log.debug("comm_amt : ", comm_amt);
                                    if (comm_amt > 0) {
                                        subtotal_commission += comm_amt;
                                    }
