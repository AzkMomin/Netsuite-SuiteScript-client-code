...
define([
  ...
  const map = (context) => {
    ...
    try {
      ...
      var tot = parseFloat(invRec.getValue('custbody_amz_commission'))
      log.debug("tot : ", tot)
      ...
      var parsedDate = format.parse({ value: invRec.getValue('custbody_date_payment'), type: format.Type.DATE });
