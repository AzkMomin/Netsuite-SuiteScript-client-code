...
function addItems(subID,itemArr,currencyID)
{
    ...
    for (var i = 0; i < itemArr.length; i++)
    {
        ...
        // If the "Toll Charges" item is NOT used and "Connected Car Services Replacement" item is NOT used, the Subscription Line needs to have the type of "Recurring"
        else
        {
            csvFile.appendLine({ value: subID+','+lineDate+','+lineNum+','+lineItem+','+lineQty+','+lineDisc+','+pricePlanID+',In Arrears,Recurring,Monthly,1' });
        }
