...
define(['N/record'], function (record) {
    function afterSubmit(context) {
        ...
        // if (context.type == 'edit' || context.type == context.UserEventType.EDIT) {
        var sfs_opp = context.newRecord;
        // log.debug('value : ', sfs_opp.getValue({ fieldId: 'custrecord_sc_sfs_opp_name' }))
        ...
        log.debug('sfs_oppIdLIneCount : ', sfs_oppIdLIneCount)
        try {
            for (var i = 0; i < 5; i++) {
            ...
            //                         })
            //                         log.debug('pricePlanData.updateNeeded : ' + pricePlanData.updateNeeded)
            //                         if (pricePlanData.updateNeeded) {
            //                             log.debug('needed')
